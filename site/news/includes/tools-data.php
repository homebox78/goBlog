...
const TOOLS = [
    ...
    'brokerage' => ['name' => '부동산 중개보수(복비) 계산기', 'icon' => 'real_estate_agent', 'category' => '금융·부동산', 'desc' => '매매·전세·월세 거래금액으로 공인중개사 중개보수(복비) 법정 상한을 구간별 요율로 계산합니다.', 'kw' => '중개보수 계산기, 부동산 복비, 중개수수료, 복비 요율, 전월세 중개보수'],
    'autotax' => ['name' => '자동차세 계산기', 'icon' => 'directions_car', 'category' => '세금', 'desc' => '배기량(cc)과 차령으로 비영업용 승용차 자동차세와 지방교육세, 차령 경감액을 계산합니다.', 'kw' => '자동차세 계산기, 자동차세 조회, cc 자동차세, 차령 경감, 지방교육세'],
    'inherit' => ['name' => '상속세 계산기', 'icon' => 'family_restroom', 'category' => '세금', 'desc' => '상속재산과 공제액으로 과세표준과 10~50% 누진세율을 적용해 예상 상속세를 계산합니다.', 'kw' => '상속세 계산기, 상속세율, 상속공제, 일괄공제 5억, 상속세 세율표'],
    'comprop' => ['name' => '종합부동산세 계산기', 'icon' => 'apartment', 'category' => '세금', 'desc' => '주택 공시가격 합계와 보유 주택 수로 종합부동산세 과세표준과 세액을 개략 계산합니다.', 'kw' => '종합부동산세 계산기, 종부세 계산, 종부세 세율, 공시가격, 1주택 종부세'],
    'breakeven' => ['name' => '손익분기점 계산기', 'icon' => 'trending_up', 'category' => '금융·부동산', 'desc' => '고정비·판매단가·변동비로 손익분기 판매량과 매출액, 공헌이익률을 계산합니다.', 'kw' => '손익분기점 계산기, BEP 계산, 손익분기 매출, 공헌이익, 창업 손익분기'],
    'smartstore' => ['name' => '스마트스토어 마진 계산기', 'icon' => 'storefront', 'category' => '금융·부동산', 'desc' => '판매가·원가·수수료·기타비용으로 스마트스토어 개당 순이익과 마진율을 계산합니다.', 'kw' => '스마트스토어 마진 계산기, 네이버 스토어 수수료, 온라인 판매 마진, 순이익 계산, 판매 수수료'],
    'corpvsindiv' => ['name' => '법인 vs 개인사업자 세금 비교', 'icon' => 'compare_arrows', 'category' => '세금', 'desc' => '연 과세표준(순이익)에 대한 개인 종합소득세와 법인세를 비교해 세액 차이를 보여줍니다.', 'kw' => '법인 개인사업자 세금, 법인전환, 법인세 개인 비교, 종합소득세 법인세, 법인 전환 유리'],
    'marketingroi' => ['name' => '마케팅 ROI·ROAS 계산기', 'icon' => 'campaign', 'category' => '크리에이터 수익', 'desc' => '광고비·광고매출·매출총이익률로 ROAS와 실이익 기준 ROI, 순이익을 계산합니다.', 'kw' => 'ROI 계산기, ROAS 계산, 마케팅 ROI, 광고 수익률, 광고비 대비 매출'],
    'avgwage' => ['name' => '평균임금 계산기', 'icon' => 'paid', 'category' => '급여·노무', 'desc' => '퇴직 전 3개월 임금 총액과 총 일수로 퇴직금·산재 기준 1일 평균임금을 계산합니다.', 'kw' => '평균임금 계산기, 1일 평균임금, 퇴직금 평균임금, 통상임금 비교, 산재 평균임금'],
    'parentleave' => ['name' => '육아휴직급여 계산기', 'icon' => 'child_care', 'category' => '급여·노무', 'desc' => '월 통상임금과 육아휴직 개월차로 2025년 개정 기준 육아휴직급여(월 지급액)를 계산합니다.', 'kw' => '육아휴직급여 계산기, 육아휴직 급여, 2025 육아휴직, 통상임금 100%, 육아휴직 상한'],
    'withholding' => ['name' => '원천세(3.3%) 계산기', 'icon' => 'receipt_long', 'category' => '급여·노무', 'desc' => '프리랜서·사업소득 지급액에서 3.3% 원천징수세액과 실수령액을 계산합니다.', 'kw' => '원천세 계산기, 3.3% 원천징수, 사업소득 원천징수, 프리랜서 세금, 원천징수 실수령'],
    'laborcost' => ['name' => '인건비 총비용 계산기', 'icon' => 'groups', 'category' => '급여·노무', 'desc' => '월급에 사업주 부담 4대보험·산재·퇴직충당을 더해 직원 1명의 실제 고용비용을 계산합니다.', 'kw' => '인건비 계산기, 고용비용, 사업주 4대보험, 인건비 총비용, 직원 채용 비용'],
    'streaming' => ['name' => '스트리밍 수익 계산기', 'icon' => 'live_tv', 'category' => '크리에이터 수익', 'desc' => '구독자·구독 단가·후원과 플랫폼 수수료로 치지직·유튜브 등 스트리밍 월 수익을 계산합니다.', 'kw' => '스트리밍 수익 계산기, 치지직 수익, 아프리카 별풍선, 유튜브 멤버십, 인터넷 방송 수익'],
    'xrevenue' => ['name' => 'X(트위터) 수익 계산기', 'icon' => 'ads_click', 'category' => '크리에이터 수익', 'desc' => '월 광고 노출수와 1,000노출당 단가로 X(트위터) 크리에이터 광고 분배 수익을 계산합니다.', 'kw' => '트위터 수익 계산기, X 크리에이터 수익, 광고 분배, 임프레션 수익, 트위터 광고 수익'],
    'freelancerfee' => ['name' => '프리랜서 수수료 계산기', 'icon' => 'handshake', 'category' => '크리에이터 수익', 'desc' => '계약금액·플랫폼 수수료·원천징수로 크몽·숨고 등 프리랜서 실수령액을 계산합니다.', 'kw' => '프리랜서 수수료 계산기, 크몽 수수료, 숨고 수수료, 프리랜서 실수령, 플랫폼 수수료'],
];
