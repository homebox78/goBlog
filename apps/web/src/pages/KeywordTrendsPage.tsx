                    ...
                    <TableBody>
                      {items.map((it) => (
                        <TableRow key={it.id}>
                          ...
                          <TableCell className="text-right font-mono text-sm">{nf(it.searchVolume)}</TableCell>
                          <TableCell className="text-right font-mono text-sm">{nf(it.totalDocs)}</TableCell>
                          <TableCell className="text-right font-mono text-sm">{it.finalScore ?? "—"}</TableCell>
                          <TableCell className="text-center text-sm">{it.rank ?? "—"}</TableCell>
                        </TableRow>
                      ))}
                    </TableBody>
                  </Table>
