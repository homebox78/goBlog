...
// 상품과 무관한 정보성/비상거래 키워드 — 여기엔 상품을 매칭하지 않는다.
const NON_COMMERCIAL =
  /주식|증시|시세|주가|전망|매수|매도|상장|코스피|코스닥|나스닥|환율|금리|배당|\betf\b|코인|비트코인|리플|이더|뉴스|속보|논란|사건|사고|판결|재판|순방|정상회담|회담|선거|대통령|의원|정치|방영|출연|드라마|예능|방송|경기|스코어|승부|우승|중계|날씨|미세먼지|지진|태풍|부고|별세/i;
